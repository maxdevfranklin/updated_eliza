...
export const starterPlugin: Plugin = {
  ...
  async init(config: Record<string, string>) {
    logger.info('Initializing plugin-grace');
    try {
  ...
  // Remove mock models to allow real AI model usage
  // models: {}, // Comment out to use default models
  routes: [
    {
      name: 'api-status',
      path: '/api/status',
  ...
  actions: [graceSherpaAction], // Only graceSherpaAction to ensure it's selected
